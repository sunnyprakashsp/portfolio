...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Sunny Prakash
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Strong in design and integration
           with intuitive problem-solving skills. Proficient in JAVA, C,
            PYTHON, JAVASCRIPT, and SQL. Passionate about implementing and
            ...
            entry-level software engineer with a reputed firm driven by technology.</p>
